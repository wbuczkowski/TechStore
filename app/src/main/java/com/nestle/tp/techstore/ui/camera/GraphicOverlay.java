 ...
 */
package com.nestle.tp.techstore.ui.camera;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public static abstract class Graphic {
         ...
         * system.
         */
        protected /*public*/ float translateX(float x) {
         ...
         * system.
         */
        protected /*public*/ float translateY(float y) {
            return scaleY(y);
        }

        protected /*public*/ void postInvalidate() {
